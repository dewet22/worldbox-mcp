...
/// <summary>
/// Throws a structured rejection that <c>HttpBridge</c> maps to a precise error envelope, /// rather than a generic 500. The HttpBridge catches BridgeRejectionException at the top of
...
/// session layer for <c>PERMISSION_DENIED</c> / <c>FACTION_SCOPE_VIOLATION</c> / etc., /// kept in a dedicated file (rather than inline in InvokePowerCommand) so the test project
